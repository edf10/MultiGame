...
public class TelaCM extends JFrame{
    ...
    //Campo do jogo
    private Campo r;//transferir(com cuidado)
    ...
    private JPanel painelNiveis;//transferir
    ...
    public void CM(int n) {
        ...
        if(n==1){
            ...
            setSize(1006, 732);
            lbsegundos.setBounds(611, 5, 100, 100);
            lbminutos.setBounds(278, 5, 100, 100);
    ...
    public void GameOver(){
        ...
        TelaGOWin tgo = new TelaGOWin(minutosP+":"+segundosP, this, 1);
    }
    ...
    public void Ganhar(int x, int y){
        ...
        if(abertos==x*y-r.getBombs()){
            if(abertos-minasAbertas==x*y-r.getBombs()){
                ...
                ct.stop();//Para o cronômetro
                TelaGOWin tgo = new TelaGOWin(minutosP+":"+segundosP, this, 2);
            }
        }
        abertos = 0;
    }
