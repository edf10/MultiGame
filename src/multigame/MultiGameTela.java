...
import soletrando.IntroductionSol;
...
public class MultiGameTela extends Frame{
    ...
    private final ImageIcon imSol = new ImageIcon(getClass().getResource("imagens/soletrando.png"));
    private void Jogos() { //Painel de exibição dos jogos
        /* Configurando lbs - PainelJogos */
        Font jogos = new Font("Tahoma", Font.PLAIN, 24);
        int lbCMP[] = {20,230,200,20}; int lbFundoP[] = {0,0,800,600};int lbJDVP[] = {230,230,200,20}; int lbSolP[] = {440,230,200,20};
        /* Configurando btns */
        BtnJogo cm = new BtnJogo(1);BtnJogo jdv = new BtnJogo(2); BtnJogo sol = new BtnJogo(3);
        ...
        Component cp[] = {
            ...
            new Lb("SOLETRANDO", jogos, lbSolP, Color.black, null),
            new Btn(imCM, null, null, btnCMP, null, false, cm),
            new Btn(imJDV, null, null, btnJDVP, null, false, jdv),
            new Btn(imSol, null, null, btnSolP, null, false, sol),
    ...
    private class BtnJogo implements ActionListener{ //Evento dos btns de jogo
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            }else if(n==3){IntroductionSol j3 = new IntroductionSol();}
